...
type RealServer struct {
	...
	HealthCheck *RealServer_HealthCheck `protobuf:"bytes,4,opt,name=health_check,json=healthCheck" json:"health_check,omitempty"`
}
...
func (m *RealServer_HealthCheck) GetEndpoint() *google_protobuf1.StringValue {
	if m != nil {
		return m.Endpoint
	}
	return nil
...
func (m *RealServer_HealthCheck) GetPeriod() *google_protobuf2.Duration {
	if m != nil {
		return m.Period
	}
	return nil
...
func (m *RealServer_HealthCheck) GetTimeout() *google_protobuf2.Duration {
	if m != nil {
		return m.Timeout
	}
	return nil
